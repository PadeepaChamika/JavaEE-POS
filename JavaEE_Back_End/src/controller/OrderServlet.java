...
public class OrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for (JsonValue object : orderDetails) {
            OrderDetailsDTO orderDetail = new OrderDetailsDTO(orderId, object.asJsonObject().getString("itemCode"), object.asJsonObject().getString("itemName"), Double.parseDouble(object.asJsonObject().getString("unitPrice")), object.asJsonObject().getInt("buyQty"), object.asJsonObject().getInt("total"));
            orderDetailDTOS.add(orderDetail);
        }

        OrderDTO orderDTO = new OrderDTO(orderId, orderDate, customerId, orderTotal, orderDetails);
        try {
