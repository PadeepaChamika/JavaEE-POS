...
public class CustomerBOImpl implements CustomerBO {
    ...
    public CustomerDTO searchCustomer(Connection connection, String id) throws SQLException, ClassNotFoundException {
        ...
        if (search !=null) {
            return new CustomerDTO(search.getId(), search.getName(),search.getAge(), search.getAddress(), search.getSalary());
        }
        return null;
    }
    ...
    public boolean addCustomer(Connection connection, CustomerDTO customerDTO) throws SQLException, ClassNotFoundException {
        Customer customer = new Customer(customerDTO.getId(), customerDTO.getName(),customerDTO.getAge(), customerDTO.getAddress(), customerDTO.getSalary());
